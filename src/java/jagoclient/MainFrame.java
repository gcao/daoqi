...
{	CheckboxMenuItem
	...
	{	super(c);
		...
		boolean constrainedapplet=c.equals(
			Global.resourceString("Daoqi_Applet"));
		// Menu :
		...
		help.add(new MenuItemAction(this,Global.resourceString("About_Daoqi")));
		...
		pack();
		Global.setwindow(this,"mainframe",400,300);
	}
	...
	{   if ("CloseEnglish".equals(o))
  		...
  		else if (Global.resourceString("About_Daoqi").equals(o))
  		{	new Help("about");
  		}
