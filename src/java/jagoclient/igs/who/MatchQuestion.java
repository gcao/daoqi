...
public class MatchQuestion extends CloseDialog {
	...
	public MatchQuestion(Frame fr, ConnectionFrame f, String user) {
		...
		//pp.add(TotalTime = new IntField(this, "TotalTime", Global.getParameter("totaltime", Defaults.TOTAL_TIME)));
		pp.add(TotalTime = new IntField(this, "TotalTime", Defaults.TOTAL_TIME));
		pp.add(new MyLabel(Global.resourceString("Extra_Time")));
		//pp.add(ExtraTime = new IntField(this, "ExtraTime", Global.getParameter("extratime", Defaults.EXTRA_TIME)));
		pp.add(ExtraTime = new IntField(this, "ExtraTime", Defaults.EXTRA_TIME));
